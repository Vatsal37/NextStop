...
import { createBookingWithTickets, getBookingDetails } from '../models/booking.model.js';

export const createBooking = asyncHandler(async (req, res) => {
	const { scheduleId, flightDate, passengers, fareAmountPerPassenger, contactEmail, contactPhone, seatIds } = req.body;
